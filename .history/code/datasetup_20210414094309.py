...
def cleanDirs():
    for f in Path('/Users/Natalie/Desktop/cs1430/CV-final-project/data/test').glob('*.txt'):
        try:
            f.unlink()
        except OSError as e:
...
def createTrain(emotion_dict):
    ...
    base_filename = '/Users/elizabethwang/Desktop/CS1430/CV-final-project/data/train/' # CHANGE ME
