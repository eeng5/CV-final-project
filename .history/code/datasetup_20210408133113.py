...
def saveIMG(arr, num, folderLoc):
    ...
    im.save(filename)
def createTrain(emotion_dict):
    df = pd.read_csv('/Users/Natalie/Desktop/cs1430/CV-final-project/data/train.csv') 
    base_filename = "/Users/Natalie/Desktop/cs1430/CV-final-project/data/train/"
    for index, row in df.iterrows():
        ...
        img_arr = augmentIMG(img)
        idx = 0
        for i in img_arr:
            num = str(index) + "_" + str(idx)
            idx +=1
            saveIMG(i, num, filename)
def createTest(emotion_dict):
    df = pd.read_csv('/Users/Natalie/Desktop/cs1430/CV-final-project/data/icml_face_data.csv') 
    base_filename = "/Users/Natalie/Desktop/cs1430/CV-final-project/data/test/"
    for index, row in df.iterrows():
...
def main():
    ...
    createTrain(emot_dict)
    createTest(emot_dict)
